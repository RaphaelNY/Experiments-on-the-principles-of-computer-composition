...
#                script (type 'Inst_addr.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Inst_addr xil_defaultlib.glbl -o Inst_addr_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Inst_addr_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Inst_addr_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Inst_addr_simv.daidir vcs_lib c.obj)
