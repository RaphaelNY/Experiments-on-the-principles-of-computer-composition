...
#
# Script generated by Vivado on Tue May 14 10:54:00 +0800 2024
...
#
# Usage        : ROM_B.sh
#                ROM_B.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROM_B.sh [-reset_run]
#                ROM_B.sh [-reset_log]
#                ROM_B.sh [-help]
#
...
#                script (type 'ROM_B.sh -help' for more information).
#
...
# script info
echo -e "ROM_B.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROM_B.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ROM_B xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ROM_B -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ROM_B_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ROM_B.sh [-reset_log]\n\
Usage: ROM_B.sh [-keep_index]\n\
